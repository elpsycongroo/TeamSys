                ...
                M = function(a, b, c, e) {
                    ...
                    if (a) { - 1 !== d.p.treeANode || d.p.scroll ? b = b > 1 ? b: 1 : (H.call(d, !1, !0), b = 1);
                        ...
                        if(t==0){
                        	...
                        	Q.push("<tr class='jqgrow ui-row-ltr ui-widget-content' role='row'>" +
                           		"<td  style='text-align:center;' colspan='"+count+"' role='gridcell'>No records to view</td>" +
                           		"</tr>");
        ...
        groupingRender: function(b, c, d, e) {
            return this.each(function() {
                ...
                function(f, v) {
                    ...
                    h = i + "_" + f,
                    n = "<button btnType='edit' class='btn btn-xs btn-info btn-edit' type='button' rowid='"+v.dataId+"'>Edit</button><span style='cursor:pointer;margin-right:8px;margin-left:5px;' class='" + r.icon_base + " " + o + "' onclick=\"jQuery('#" + a.jgrid.jqID(k.p.id) + "').jqGrid('groupingToggle','" + h + "');return false;\"></span>";
                    try {
