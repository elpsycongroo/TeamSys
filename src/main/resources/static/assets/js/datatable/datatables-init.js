    ...
    return {
        init: function () {
            ...
            function fnFormatDetails(oTable, nTr) {
                ...
                var sOut = '<table class="table table-hover table-striped table-bordered"><tbody><tr><td><div class="col-xs-3">特征编码：<input type="text" placeholder="特征编码" value="XAAZ"/></div><div class="col-xs-3">特征名称：<input type="text" placeholder="特征名称" value="前驱方式"/></div><div class="col-xs-3"><a href="#" class="btn btn-info btn-xs edit bootbox-edit-options"><i class="fa fa-edit"></i> 保存</a></div></td></tr><tr><td class="detailsx"><div class="col-xs-3">特征编码：<input type="text" placeholder="特征编码" value="WABC"/></div><div class="col-xs-3">特征名称：<input type="text" placeholder="特征名称" value="后驱方式"/></div><div class="col-xs-3"><a href="#" class="btn btn-info btn-xs edit bootbox-edit-options"><i class="fa fa-edit"></i> 保存</a></div></td></tr></tbody></table>';
            ...
            $('#expandabledatatable').on('click', ' tbody td .row-details', function () {
                ...
                if (oTable.fnIsOpen(nTr)) {
                    ...
                    $(".detailsx .bootbox-edit-options").on('click', function () {
                        bootbox.dialog({
